...
```env
MONGODB_URI=mongodb+srv://vadimlavrenchuk:OLD_COMPROMISED_PASSWORD@mechanicpro.wjylube.mongodb.net/MechanicPro?retryWrites=true&w=majority&appName=MechanicPro
```
...
```env
MONGODB_URI=mongodb+srv://vadimlavrenchuk:YOUR_NEW_SECURE_PASSWORD@mechanicpro.wjylube.mongodb.net/MechanicPro?retryWrites=true&w=majority&appName=MechanicPro
```
