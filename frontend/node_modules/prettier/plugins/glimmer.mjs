...
`,a);if(o===-1&&(o=this.source.length),i===r-1){if(a+n>o)return o;if($n){let c=this.hbsPosFor(a+n);c.line,c.column}return a+n}if(o===-1)return 0;i+=1,a=o+1}return s}};function k(e,t){let{module:r,loc:n}=t,{line:s,column:i}=n.start,a=t.asString(),o=a?`
...
`:"",c=new Error(`${e}: ${o}(error occurred in '${r}' @ line ${s} : column ${i})`);return c.name="SyntaxError",c.location=t,c.code=a,c}var ni={Template:["body"],Block:["body"],MustacheStatement:["path","params","hash"],BlockStatement:["path","params","hash","program","inverse"],ElementModifierStatement:["path","params","hash"],CommentStatement:[],MustacheCommentStatement:[],ElementNode:["attributes","modifiers","children","comments"],AttrNode:["value"],TextNode:[],ConcatStatement:["parts"],SubExpression:["path","params","hash"],PathExpression:[],StringLiteral:[],BooleanLiteral:[],NumberLiteral:[],NullLiteral:[],UndefinedLiteral:[],Hash:["pairs"],HashPair:["value"]},gr=(function(){function e(t,r,n,s){let i=Error.call(this,t);this.key=s,this.message=t,this.node=r,this.parent=n,i.stack&&(this.stack=i.stack)}return e.prototype=Object.create(Error.prototype),e.prototype.constructor=e,e})();function ds(e,t,r){return new gr("Cannot remove a node unless it is part of an array",e,t,r)}function ii(e,t,r){return new gr("Cannot replace a node with multiple nodes unless it is part of an array",e,t,r)}function gs(e,t){return new gr("Replacing and removing in key handlers is not yet supported.",e,null,t)}var Lt=class{constructor(t,r=null,n=null){this.node=t,this.parent=r,this.parentKey=n}get parentNode(){return this.parent?this.parent.node:null}parents(){return{[Symbol.iterator]:()=>new ur(this)}}},ur=class{constructor(t){this.path=t}next(){return this.path.parent?(this.path=this.path.parent,{done:!1,value:this.path}):{done:!0,value:null}}};function ws(e){return typeof e=="function"?e:e.enter}function Ts(e){return typeof e=="function"?void 0:e.exit}function ke(e,t){let r,n,s,{node:i,parent:a,parentKey:o}=t,c=(function(h,f){if(h.Program&&(f==="Template"&&!h.Template||f==="Block"&&!h.Block))return h.Program;let p=h[f];return p!==void 0?p:h.All})(e,i.type);if(c!==void 0&&(r=ws(c),n=Ts(c)),r!==void 0&&(s=r(i,t)),s!=null){if(JSON.stringify(i)!==JSON.stringify(s))return Array.isArray(s)?(xs(e,s,a,o),s):ke(e,new Lt(s,a,o))||s;s=void 0}if(s===void 0){let h=ni[i.type];for(let f=0;f<h.length;f++)ai(e,c,t,h[f]);n!==void 0&&(s=n(i,t))}return s}function bs(e,t,r){e[t]=r}function ai(e,t,r,n){let s,i,{node:a}=r,o=(function(c,h){return c[h]})(a,n);if(o){if(t!==void 0){let c=(function(h,f){let p=typeof h!="function"?h.keys:void 0;if(p===void 0)return;let g=p[f];return g!==void 0?g:p.All})(t,n);c!==void 0&&(s=ws(c),i=Ts(c))}if(s!==void 0&&s(a,n)!==void 0)throw gs(a,n);if(Array.isArray(o))xs(e,o,r,n);else{let c=ke(e,new Lt(o,r,n));c!==void 0&&(function(h,f,p,g){if(g===null)throw ds(p,h,f);if(Array.isArray(g)){if(g.length!==1)throw g.length===0?ds(p,h,f):ii(p,h,f);bs(h,f,g[0])}else bs(h,f,g)})(a,n,o,c)}if(i!==void 0&&i(a,n)!==void 0)throw gs(a,n)}}function xs(e,t,r,n){for(let s=0;s<t.length;s++){let i=t[s],a=ke(e,new Lt(i,r,n));a!==void 0&&(s+=oi(t,s,a)-1)}}function oi(e,t,r){return r===null?(e.splice(t,1),0):Array.isArray(r)?(e.splice(t,1,...r),r.length):(e.splice(t,1,r),1)}function li(e,t){ke(t,new Lt(e))}function Pt(e,t){(function(r){switch(r.type){case"Block":case"Template":return r.body;case"ElementNode":return r.children}})(e).push(t)}function Ns(e){return e.type==="StringLiteral"||e.type==="BooleanLiteral"||e.type==="NumberLiteral"||e.type==="NullLiteral"||e.type==="UndefinedLiteral"}var tr;function er(){return tr||(tr=new ft("","(synthetic)")),tr}function ys(e,t){return d.var({name:e,loc:v(t||null)})}function rt(e,t){let r=v(t||null);if(typeof e!="string"){if("type"in e)return e;{e.head.indexOf(".");let{head:i,tail:a}=e;return d.path({head:d.head({original:i,loc:r.sliceStartChars({chars:i.length})}),tail:a,loc:v(t||null)})}}let{head:n,tail:s}=(function(i,a){let[o,...c]=i.split("."),h=d.head({original:o,loc:v(a||null)});return d.path({head:h,tail:c,loc:v(a||null)})})(e,r);return d.path({head:n,tail:s,loc:r})}function ye(e,t,r){return d.literal({type:e,value:t,loc:v(r||null)})}function Mt(e=[],t){return d.hash({pairs:e,loc:v(t||null)})}function As(e){return e.map((t=>typeof t=="string"?d.var({name:t,loc:A.synthetic(t)}):t))}function Ss(e=[],t=[],r=!1,n){return d.blockItself({body:e,params:As(t),chained:r,loc:v(n||null)})}function ks(e=[],t=[],r){return d.template({body:e,blockParams:t,loc:v(r||null)})}function v(...e){if(e.length===1){let t=e[0];return t&&typeof t=="object"?A.forHbsLoc(er(),t):A.forHbsLoc(er(),ri)}{let[t,r,n,s,i]=e,a=i?new ft("",i):er();return A.forHbsLoc(a,{start:{line:t,column:r},end:{line:n||t,column:s||r}})}}var ci={mustache:function(e,t=[],r=Mt([]),n=!1,s,i){return d.mustache({path:rt(e),params:t,hash:r,trusting:n,strip:i,loc:v(s||null)})},block:function(e,t,r,n,s=null,i,a,o,c){let h,f=null;return h=n.type==="Template"?d.blockItself({params:As(n.blockParams),body:n.body,loc:n.loc}):n,s?.type==="Template"?(s.blockParams.length,f=d.blockItself({params:[],body:s.body,loc:s.loc})):f=s,d.block({path:rt(e),params:t||[],hash:r||Mt([]),defaultBlock:h,elseBlock:f,loc:v(i||null),openStrip:a,inverseStrip:o,closeStrip:c})},comment:function(e,t){return d.comment({value:e,loc:v(t||null)})},mustacheComment:function(e,t){return d.mustacheComment({value:e,loc:v(t||null)})},element:function(e,t={}){let r,n,{attrs:s,blockParams:i,modifiers:a,comments:o,children:c,openTag:h,closeTag:f,loc:p}=t;typeof e=="string"?e.endsWith("/")?(r=rt(e.slice(0,-1)),n=!0):r=rt(e):"type"in e?(e.type,e.type,r=e):"path"in e?(e.path.type,e.path.type,r=e.path,n=e.selfClosing):(r=rt(e.name),n=e.selfClosing);let g=i?.map((T=>typeof T=="string"?ys(T):T)),E=null;return f?E=v(f):f===void 0&&(E=n||ti(r.original)?null:v(null)),d.element({path:r,selfClosing:n||!1,attributes:s||[],params:g||[],modifiers:a||[],comments:o||[],children:c||[],openTag:v(h||null),closeTag:E,loc:v(p||null)})},elementModifier:function(e,t,r,n){return d.elementModifier({path:rt(e),params:t||[],hash:r||Mt([]),loc:v(n||null)})},attr:function(e,t,r){return d.attr({name:e,value:t,loc:v(r||null)})},text:function(e="",t){return d.text({chars:e,loc:v(t||null)})},sexpr:function(e,t=[],r=Mt([]),n){return d.sexpr({path:rt(e),params:t,hash:r,loc:v(n||null)})},concat:function(e,t){if(!Kt(e))throw new Error("b.concat requires at least one part");return d.concat({parts:e,loc:v(t||null)})},hash:Mt,pair:function(e,t,r){return d.pair({key:e,value:t,loc:v(r||null)})},literal:ye,program:function(e,t,r){return t&&t.length?Ss(e,t,!1,r):ks(e,[],r)},blockItself:Ss,template:ks,loc:v,pos:function(e,t){return d.pos({line:e,column:t})},path:rt,fullPath:function(e,t=[],r){return d.path({head:e,tail:t,loc:v(r||null)})},head:function(e,t){return d.head({original:e,loc:v(t||null)})},at:function(e,t){return d.atName({name:e,loc:v(t||null)})},var:ys,this:function(e){return d.this({loc:v(e||null)})},string:rr("StringLiteral"),boolean:rr("BooleanLiteral"),number:rr("NumberLiteral"),undefined:()=>ye("UndefinedLiteral",void 0),null:()=>ye("NullLiteral",null)};function rr(e){return function(t,r){return ye(e,t,r)}}var be={close:!1,open:!1},d=new class{pos({line:e,column:t}){return{line:e,column:t}}blockItself({body:e,params:t,chained:r=!1,loc:n}){return{type:"Block",body:e,params:t,get blockParams(){return this.params.map((s=>s.name))},set blockParams(s){this.params=s.map((i=>d.var({name:i,loc:A.synthetic(i)})))},chained:r,loc:n}}template({body:e,blockParams:t,loc:r}){return{type:"Template",body:e,blockParams:t,loc:r}}mustache({path:e,params:t,hash:r,trusting:n,loc:s,strip:i=be}){return(function({path:a,params:o,hash:c,trusting:h,strip:f,loc:p}){let g={type:"MustacheStatement",path:a,params:o,hash:c,trusting:h,strip:f,loc:p};return Object.defineProperty(g,"escaped",{enumerable:!1,get(){return!this.trusting},set(E){this.trusting=!E}}),g})({path:e,params:t,hash:r,trusting:n,strip:i,loc:s})}block({path:e,params:t,hash:r,defaultBlock:n,elseBlock:s=null,loc:i,openStrip:a=be,inverseStrip:o=be,closeStrip:c=be}){return{type:"BlockStatement",path:e,params:t,hash:r,program:n,inverse:s,loc:i,openStrip:a,inverseStrip:o,closeStrip:c}}comment({value:e,loc:t}){return{type:"CommentStatement",value:e,loc:t}}mustacheComment({value:e,loc:t}){return{type:"MustacheCommentStatement",value:e,loc:t}}concat({parts:e,loc:t}){return{type:"ConcatStatement",parts:e,loc:t}}element({path:e,selfClosing:t,attributes:r,modifiers:n,params:s,comments:i,children:a,openTag:o,closeTag:c,loc:h}){let f=t;return{type:"ElementNode",path:e,attributes:r,modifiers:n,params:s,comments:i,children:a,openTag:o,closeTag:c,loc:h,get tag(){return this.path.original},set tag(p){this.path.original=p},get blockParams(){return this.params.map((p=>p.name))},set blockParams(p){this.params=p.map((g=>d.var({name:g,loc:A.synthetic(g)})))},get selfClosing(){return f},set selfClosing(p){f=p,this.closeTag=p?null:A.synthetic(`</${this.tag}>`)}}}elementModifier({path:e,params:t,hash:r,loc:n}){return{type:"ElementModifierStatement",path:e,params:t,hash:r,loc:n}}attr({name:e,value:t,loc:r}){return{type:"AttrNode",name:e,value:t,loc:r}}text({chars:e,loc:t}){return{type:"TextNode",chars:e,loc:t}}sexpr({path:e,params:t,hash:r,loc:n}){return{type:"SubExpression",path:e,params:t,hash:r,loc:n}}path({head:e,tail:t,loc:r}){return(function({head:n,tail:s,loc:i}){let a={type:"PathExpression",head:n,tail:s,get original(){return[this.head.original,...this.tail].join(".")},set original(o){let[c,...h]=o.split(".");this.head=ci.head(c,this.head.loc),this.tail=h},loc:i};return Object.defineProperty(a,"parts",{enumerable:!1,get(){let o=this.original.split(".");return o[0]==="this"?o.shift():o[0].startsWith("@")&&(o[0]=o[0].slice(1)),Object.freeze(o)},set(o){let c=[...o];c[0]==="this"||c[0]?.startsWith("@")||(this.head.type==="ThisHead"?c.unshift("this"):this.head.type==="AtHead"&&(c[0]=`@${c[0]}`)),this.original=c.join(".")}}),Object.defineProperty(a,"this",{enumerable:!1,get(){return this.head.type==="ThisHead"}}),Object.defineProperty(a,"data",{enumerable:!1,get(){return this.head.type==="AtHead"}}),a})({head:e,tail:t,loc:r})}head({original:e,loc:t}){return e==="this"?this.this({loc:t}):e[0]==="@"?this.atName({name:e,loc:t}):this.var({name:e,loc:t})}this({loc:e}){return{type:"ThisHead",get original(){return"this"},loc:e}}atName({name:e,loc:t}){let r="",n={type:"AtHead",get name(){return r},set name(s){s[0],s.indexOf("."),r=s},get original(){return this.name},set original(s){this.name=s},loc:t};return n.name=e,n}var({name:e,loc:t}){let r="",n={type:"VarHead",get name(){return r},set name(s){s[0],s.indexOf("."),r=s},get original(){return this.name},set original(s){this.name=s},loc:t};return n.name=e,n}hash({pairs:e,loc:t}){return{type:"Hash",pairs:e,loc:t}}pair({key:e,value:t,loc:r}){return{type:"HashPair",key:e,value:t,loc:r}}literal({type:e,value:t,loc:r}){return(function({type:n,value:s,loc:i}){let a={type:n,value:s,loc:i};return Object.defineProperty(a,"original",{enumerable:!1,get(){return this.value},set(o){this.value=o}}),a})({type:e,value:t,loc:r})}},hr=class{constructor(t,r=new Xe(fs),n="precompile"){this.elementStack=[],this.currentAttribute=null,this.currentNode=null,this.source=t,this.lines=t.source.split(/\r\n?|\n/u),this.tokenizer=new Ze(this,r,n)}offset(){let{line:t,column:r}=this.tokenizer;return this.source.offsetFor(t,r)}pos({line:t,column:r}){return this.source.offsetFor(t,r)}finish(t){return Ye({},t,{loc:t.start.until(this.offset())})}get currentAttr(){return this.currentAttribute}get currentTag(){let t=this.currentNode;return t&&(t.type==="StartTag"||t.type),t}get currentStartTag(){let t=this.currentNode;return t&&t.type,t}get currentEndTag(){let t=this.currentNode;return t&&t.type,t}get currentComment(){let t=this.currentNode;return t&&t.type,t}get currentData(){let t=this.currentNode;return t&&t.type,t}acceptNode(t){return this[t.type](t)}currentElement(){return dr(this.elementStack)}sourceForNode(t,r){let n,s,i,a=t.loc.start.line-1,o=a-1,c=t.loc.start.column,h=[];for(r?(s=r.loc.end.line-1,i=r.loc.end.column):(s=t.loc.end.line-1,i=t.loc.end.column);o<s;)o++,n=this.lines[o],o===a?a===s?h.push(n.slice(c,i)):h.push(n.slice(c)):o===s?h.push(n.slice(0,i)):h.push(n);return h.join(`
`)}},pr=class extends hr{parse(t,r){t.loc;let n=d.template({body:[],blockParams:r,loc:this.source.spanFor(t.loc)}),s=this.parseProgram(n,t);return this.pendingError?.eof(s.loc.getEnd()),s}Program(t,r){t.loc;let n=d.blockItself({body:[],params:r,chained:t.chained,loc:this.source.spanFor(t.loc)});return this.parseProgram(n,t)}parseProgram(t,r){if(r.body.length===0)return t;let n;try{this.elementStack.push(t);for(let s of r.body)this.acceptNode(s)}finally{n=this.elementStack.pop()}if(t!==n){if(n?.type==="ElementNode")throw k(`Unclosed element \`${n.tag}\``,n.loc);t.type}return t}BlockStatement(t){if(this.tokenizer.state==="comment")return t.loc,void this.appendToCommentData(this.sourceForNode(t));if(this.tokenizer.state!=="data"&&this.tokenizer.state!=="beforeData")throw k("A block may only be used inside an HTML element or another block.",this.source.spanFor(t.loc));let{path:r,params:n,hash:s}=sr(this,t),i=this.source.spanFor(t.loc),a,o=[];if(t.program.blockParams?.length){let p=s.loc.collapse("end");p=t.program.loc?p.withEnd(this.source.spanFor(t.program.loc).getStart()):t.program.body[0]?p.withEnd(this.source.spanFor(t.program.body[0].loc).getStart()):p.withEnd(i.getEnd()),a=Es(this.source,t,p);let g=p.asString(),E=g.indexOf("|")+1,T=g.indexOf("|",E);for(let D of t.program.blockParams){let I,O;I=E>=T?-1:g.indexOf(D,E),I===-1||I+D.length>T?(E=T,O=this.source.spanFor(ar)):(E=I,O=p.sliceStartChars({skipStart:E,chars:D.length}),E+=D.length),o.push(d.var({name:D,loc:O}))}}else a=Es(this.source,t,i);let c=this.Program(a.program,o),h=a.inverse?this.Program(a.inverse,[]):null,f=d.block({path:r,params:n,hash:s,defaultBlock:c,elseBlock:h,loc:this.source.spanFor(t.loc),openStrip:t.openStrip,inverseStrip:t.inverseStrip,closeStrip:t.closeStrip});Pt(this.currentElement(),f)}MustacheStatement(t){this.pendingError?.mustache(this.source.spanFor(t.loc));let{tokenizer:r}=this;if(r.state==="comment")return void this.appendToCommentData(this.sourceForNode(t));let n,{escaped:s,loc:i,strip:a}=t;if("original"in t.path&&t.path.original==="...attributes")throw k("Illegal use of ...attributes",this.source.spanFor(t.loc));if(Ns(t.path))n=d.mustache({path:this.acceptNode(t.path),params:[],hash:d.hash({pairs:[],loc:this.source.spanFor(t.path.loc).collapse("end")}),trusting:!s,loc:this.source.spanFor(i),strip:a});else{let{path:o,params:c,hash:h}=sr(this,t);n=d.mustache({path:o,params:c,hash:h,trusting:!s,loc:this.source.spanFor(i),strip:a})}switch(r.state){case"tagOpen":case"tagName":throw k("Cannot use mustaches in an elements tagname",n.loc);case"beforeAttributeName":nr(this.currentStartTag,n);break;case"attributeName":case"afterAttributeName":this.beginAttributeValue(!1),this.finishAttributeValue(),nr(this.currentStartTag,n),r.transitionTo("beforeAttributeName");break;case"afterAttributeValueQuoted":nr(this.currentStartTag,n),r.transitionTo("beforeAttributeName");break;case"beforeAttributeValue":this.beginAttributeValue(!1),this.appendDynamicAttributeValuePart(n),r.transitionTo("attributeValueUnquoted");break;case"attributeValueDoubleQuoted":case"attributeValueSingleQuoted":case"attributeValueUnquoted":this.appendDynamicAttributeValuePart(n);break;default:Pt(this.currentElement(),n)}return n}appendDynamicAttributeValuePart(t){this.finalizeTextPart();let r=this.currentAttr;r.isDynamic=!0,r.parts.push(t)}finalizeTextPart(){let t=this.currentAttr.currentPart;t!==null&&(this.currentAttr.parts.push(t),this.startTextPart())}startTextPart(){this.currentAttr.currentPart=null}ContentStatement(t){(function(r,n){let s=n.loc.start.line,i=n.loc.start.column,a=(function(o,c){if(c==="")return{lines:o.split(`
`).length-1,columns:0};let[h]=o.split(c),f=h.split(/\n/u),p=f.length-1;return{lines:p,columns:f[p].length}})(n.original,n.value);s+=a.lines,a.lines?i=a.columns:i+=a.columns,r.line=s,r.column=i})(this.tokenizer,t),this.tokenizer.tokenizePart(t.value),this.tokenizer.flushData()}CommentStatement(t){let{tokenizer:r}=this;if(r.state==="comment")return this.appendToCommentData(this.sourceForNode(t)),null;let{value:n,loc:s}=t,i=d.mustacheComment({value:n,loc:this.source.spanFor(s)});switch(r.state){case"beforeAttributeName":case"afterAttributeName":this.currentStartTag.comments.push(i);break;case"beforeData":case"data":Pt(this.currentElement(),i);break;default:throw k(`Using a Handlebars comment when in the \`${r.state}\` state is not supported`,this.source.spanFor(t.loc))}return i}PartialStatement(t){throw k("Handlebars partials are not supported",this.source.spanFor(t.loc))}PartialBlockStatement(t){throw k("Handlebars partial blocks are not supported",this.source.spanFor(t.loc))}Decorator(t){throw k("Handlebars decorators are not supported",this.source.spanFor(t.loc))}DecoratorBlock(t){throw k("Handlebars decorator blocks are not supported",this.source.spanFor(t.loc))}SubExpression(t){let{path:r,params:n,hash:s}=sr(this,t);return d.sexpr({path:r,params:n,hash:s,loc:this.source.spanFor(t.loc)})}PathExpression(t){let{original:r}=t,n;if(r.indexOf("/")!==-1){if(r.slice(0,2)==="./")throw k('Using "./" is not supported in Glimmer and unnecessary',this.source.spanFor(t.loc));if(r.slice(0,3)==="../")throw k('Changing context using "../" is not supported in Glimmer',this.source.spanFor(t.loc));if(r.indexOf(".")!==-1)throw k("Mixing '.' and '/' in paths is not supported in Glimmer; use only '.' to separate property paths",this.source.spanFor(t.loc));n=[t.parts.join("/")]}else{if(r===".")throw k("'.' is not a supported path in Glimmer; check for a path with a trailing '.'",this.source.spanFor(t.loc));n=t.parts}let s,i=!1;if(/^this(?:\..+)?$/u.test(r)&&(i=!0),i)s=d.this({loc:this.source.spanFor({start:t.loc.start,end:{line:t.loc.start.line,column:t.loc.start.column+4}})});else if(t.data){let a=n.shift();if(a===void 0)throw k("Attempted to parse a path expression, but it was not valid. Paths beginning with @ must start with a-z.",this.source.spanFor(t.loc));s=d.atName({name:`@${a}`,loc:this.source.spanFor({start:t.loc.start,end:{line:t.loc.start.line,column:t.loc.start.column+a.length+1}})})}else{let a=n.shift();if(a===void 0)throw k("Attempted to parse a path expression, but it was not valid. Paths must start with a-z or A-Z.",this.source.spanFor(t.loc));s=d.var({name:a,loc:this.source.spanFor({start:t.loc.start,end:{line:t.loc.start.line,column:t.loc.start.column+a.length}})})}return d.path({head:s,tail:n,loc:this.source.spanFor(t.loc)})}Hash(t){let r=t.pairs.map((n=>d.pair({key:n.key,value:this.acceptNode(n.value),loc:this.source.spanFor(n.loc)})));return d.hash({pairs:r,loc:this.source.spanFor(t.loc)})}StringLiteral(t){return d.literal({type:"StringLiteral",value:t.value,loc:this.source.spanFor(t.loc)})}BooleanLiteral(t){return d.literal({type:"BooleanLiteral",value:t.value,loc:this.source.spanFor(t.loc)})}NumberLiteral(t){return d.literal({type:"NumberLiteral",value:t.value,loc:this.source.spanFor(t.loc)})}UndefinedLiteral(t){return d.literal({type:"UndefinedLiteral",value:void 0,loc:this.source.spanFor(t.loc)})}NullLiteral(t){return d.literal({type:"NullLiteral",value:null,loc:this.source.spanFor(t.loc)})}constructor(...t){super(...t),this.pendingError=null}};function sr(e,t){let r;switch(t.path.type){case"PathExpression":r=e.PathExpression(t.path);break;case"SubExpression":r=e.SubExpression(t.path);break;case"StringLiteral":case"UndefinedLiteral":case"NullLiteral":case"NumberLiteral":case"BooleanLiteral":{let i;throw i=t.path.type==="BooleanLiteral"?t.path.original.toString():t.path.type==="StringLiteral"?`"${t.path.original}"`:t.path.type==="NullLiteral"?"null":t.path.type==="NumberLiteral"?t.path.value.toString():"undefined",k(`${t.path.type} "${t.path.type==="StringLiteral"?t.path.original:i}" cannot be called as a sub-expression, replace (${i}) with ${i}`,e.source.spanFor(t.path.loc))}}let n=t.params.map((i=>e.acceptNode(i))),s=Kt(n)?dr(n).loc:r.loc;return{path:r,params:n,hash:t.hash?e.Hash(t.hash):d.hash({pairs:[],loc:e.source.spanFor(s).collapse("end")})}}function nr(e,t){let{path:r,params:n,hash:s,loc:i}=t;if(Ns(r)){let o=`{{${(function(c){return c.type==="UndefinedLiteral"?"undefined":JSON.stringify(c.value)})(r)}}}`;throw k(`In <${e.name} ... ${o} ..., ${o} is not a valid modifier`,t.loc)}let a=d.elementModifier({path:r,params:n,hash:s,loc:i});e.modifiers.push(a)}function Es(e,t,r){if(!t.program.loc){let s=V(0,t.program.body,0),i=V(0,t.program.body,-1);if(s&&i)t.program.loc={...s.loc,end:i.loc.end};else{let a=e.spanFor(t.loc);t.program.loc=r.withEnd(a.getEnd())}}let n=e.spanFor(t.program.loc).getEnd();return t.inverse&&!t.inverse.loc&&(t.inverse.loc=n.collapsed()),t}function At(e){return/[\t\n\f ]/u.test(e)}var fr=class extends pr{reset(){this.currentNode=null}beginComment(){this.currentNode={type:"CommentStatement",value:"",start:this.source.offsetFor(this.tagOpenLine,this.tagOpenColumn)}}appendToCommentData(t){this.currentComment.value+=t}finishComment(){Pt(this.currentElement(),d.comment(this.finish(this.currentComment)))}beginData(){this.currentNode={type:"TextNode",chars:"",start:this.offset()}}appendToData(t){this.currentData.chars+=t}finishData(){Pt(this.currentElement(),d.text(this.finish(this.currentData)))}tagOpen(){this.tagOpenLine=this.tokenizer.line,this.tagOpenColumn=this.tokenizer.column}beginStartTag(){this.currentNode={type:"StartTag",name:"",nameStart:null,nameEnd:null,attributes:[],modifiers:[],comments:[],params:[],selfClosing:!1,start:this.source.offsetFor(this.tagOpenLine,this.tagOpenColumn)}}beginEndTag(){this.currentNode={type:"EndTag",name:"",start:this.source.offsetFor(this.tagOpenLine,this.tagOpenColumn)}}finishTag(){let t=this.finish(this.currentTag);if(t.type==="StartTag"){if(this.finishStartTag(),t.name===":")throw k("Invalid named block named detected, you may have created a named block without a name, or you may have began your name with a number. Named blocks must have names that are at least one character long, and begin with a lower case letter",this.source.spanFor({start:this.currentTag.start.toJSON(),end:this.offset().toJSON()}));(ir.has(t.name)||t.selfClosing)&&this.finishEndTag(!0)}else t.type,t.type,this.finishEndTag(!1)}finishStartTag(){let{name:t,nameStart:r,nameEnd:n}=this.currentStartTag,s=r.until(n),[i,...a]=t.split("."),o=d.path({head:d.head({original:i,loc:s.sliceStartChars({chars:i.length})}),tail:a,loc:s}),{attributes:c,modifiers:h,comments:f,params:p,selfClosing:g,loc:E}=this.finish(this.currentStartTag),T=d.element({path:o,selfClosing:g,attributes:c,modifiers:h,comments:f,params:p,children:[],openTag:E,closeTag:g?null:A.broken(),loc:E});this.elementStack.push(T)}finishEndTag(t){let{start:r}=this.currentTag,n=this.finish(this.currentTag),s=this.elementStack.pop();this.validateEndTag(n,s,t);let i=this.currentElement();t?s.closeTag=null:s.selfClosing?s.closeTag:s.closeTag=r.until(this.offset()),s.loc=s.loc.withEnd(this.offset()),Pt(i,d.element(s))}markTagAsSelfClosing(){let t=this.currentTag;if(t.type!=="StartTag")throw k("Invalid end tag: closing tag must not be self-closing",this.source.spanFor({start:t.start.toJSON(),end:this.offset().toJSON()}));t.selfClosing=!0}appendToTagName(t){let r=this.currentTag;if(r.name+=t,r.type==="StartTag"){let n=this.offset();r.nameStart===null&&(r.nameEnd,r.nameStart=n.move(-1)),r.nameEnd=n}}beginAttribute(){let t=this.offset();this.currentAttribute={name:"",parts:[],currentPart:null,isQuoted:!1,isDynamic:!1,start:t,valueSpan:t.collapsed()}}appendToAttributeName(t){this.currentAttr.name+=t,this.currentAttr.name==="as"&&this.parsePossibleBlockParams()}beginAttributeValue(t){this.currentAttr.isQuoted=t,this.startTextPart(),this.currentAttr.valueSpan=this.offset().collapsed()}appendToAttributeValue(t){let r=this.currentAttr.parts,n=r[r.length-1],s=this.currentAttr.currentPart;if(s)s.chars+=t,s.loc=s.loc.withEnd(this.offset());else{let i=this.offset();i=t===`
`?n?n.loc.getEnd():this.currentAttr.valueSpan.getStart():i.move(-1),this.currentAttr.currentPart=d.text({chars:t,loc:i.collapsed()})}}finishAttributeValue(){this.finalizeTextPart();let t=this.currentTag,r=this.offset();if(t.type==="EndTag")throw k("Invalid end tag: closing tag must not have attributes",this.source.spanFor({start:t.start.toJSON(),end:r.toJSON()}));let{name:n,parts:s,start:i,isQuoted:a,isDynamic:o,valueSpan:c}=this.currentAttr;if(n.startsWith("|")&&s.length===0&&!a&&!o)throw k("Invalid block parameters syntax: block parameters must be preceded by the `as` keyword",i.until(i.move(n.length)));let h=this.assembleAttributeValue(s,a,o,i.until(r));h.loc=c.withEnd(r);let f=d.attr({name:n,value:h,loc:i.until(r)});this.currentStartTag.attributes.push(f)}parsePossibleBlockParams(){let t=/[!"#%&'()*+./;<=>@[\\\]^`{|}~]/u;this.tokenizer.state;let r=this.currentStartTag,n=this.currentAttr,s={state:"PossibleAs"},i={PossibleAs:o=>{if(s.state,At(o))s={state:"BeforeStartPipe"},this.tokenizer.transitionTo("afterAttributeName"),this.tokenizer.consume();else{if(o==="|")throw k('Invalid block parameters syntax: expecting at least one space character between "as" and "|"',n.start.until(this.offset().move(1)));s={state:"Done"}}},BeforeStartPipe:o=>{s.state,At(o)?this.tokenizer.consume():o==="|"?(s={state:"BeforeBlockParamName"},this.tokenizer.transitionTo("beforeAttributeName"),this.tokenizer.consume()):s={state:"Done"}},BeforeBlockParamName:o=>{if(s.state,At(o))this.tokenizer.consume();else if(o==="")s={state:"Done"},this.pendingError={mustache(c){throw k("Invalid block parameters syntax: mustaches cannot be used inside parameters list",c)},eof(c){throw k('Invalid block parameters syntax: expecting the tag to be closed with ">" or "/>" after parameters list',n.start.until(c))}};else if(o==="|"){if(r.params.length===0)throw k("Invalid block parameters syntax: empty parameters list, expecting at least one identifier",n.start.until(this.offset().move(1)));s={state:"AfterEndPipe"},this.tokenizer.consume()}else{if(o===">"||o==="/")throw k('Invalid block parameters syntax: incomplete parameters list, expecting "|" but the tag was closed prematurely',n.start.until(this.offset().move(1)));s={state:"BlockParamName",name:o,start:this.offset()},this.tokenizer.consume()}},BlockParamName:o=>{if(s.state,o==="")s={state:"Done"},this.pendingError={mustache(c){throw k("Invalid block parameters syntax: mustaches cannot be used inside parameters list",c)},eof(c){throw k('Invalid block parameters syntax: expecting the tag to be closed with ">" or "/>" after parameters list',n.start.until(c))}};else if(o==="|"||At(o)){let c=s.start.until(this.offset());if(s.name==="this"||t.test(s.name))throw k(`Invalid block parameters syntax: invalid identifier name \`${s.name}\``,c);r.params.push(d.var({name:s.name,loc:c})),s=o==="|"?{state:"AfterEndPipe"}:{state:"BeforeBlockParamName"},this.tokenizer.consume()}else{if(o===">"||o==="/")throw k('Invalid block parameters syntax: expecting "|" but the tag was closed prematurely',n.start.until(this.offset().move(1)));s.name+=o,this.tokenizer.consume()}},AfterEndPipe:o=>{s.state,At(o)?this.tokenizer.consume():o===""?(s={state:"Done"},this.pendingError={mustache(c){throw k("Invalid block parameters syntax: modifiers cannot follow parameters list",c)},eof(c){throw k('Invalid block parameters syntax: expecting the tag to be closed with ">" or "/>" after parameters list',n.start.until(c))}}):o===">"||o==="/"?s={state:"Done"}:(s={state:"Error",message:'Invalid block parameters syntax: expecting the tag to be closed with ">" or "/>" after parameters list',start:this.offset()},this.tokenizer.consume())},Error:o=>{if(s.state,o===""||o==="/"||o===">"||At(o))throw k(s.message,s.start.until(this.offset()));this.tokenizer.consume()},Done:()=>{}},a;do a=this.tokenizer.peek(),i[s.state](a);while(s.state!=="Done"&&a!=="");s.state}reportSyntaxError(t){throw k(t,this.offset().collapsed())}assembleConcatenatedValue(t){let r=ei(t),n=dr(t);return d.concat({parts:t,loc:this.source.spanFor(r.loc).extend(this.source.spanFor(n.loc))})}validateEndTag(t,r,n){if(ir.has(t.name)&&!n)throw k(`<${t.name}> elements do not need end tags. You should remove it`,t.loc);if(r.type!=="ElementNode")throw k(`Closing tag </${t.name}> without an open tag`,t.loc);if(r.tag!==t.name)throw k(`Closing tag </${t.name}> did not match last open tag <${r.tag}> (on line ${r.loc.startPosition.line})`,t.loc)}assembleAttributeValue(t,r,n,s){if(n){if(r)return this.assembleConcatenatedValue(t);{let[i,a]=t;if(a===void 0||a.type==="TextNode"&&a.chars==="/")return i;throw k("An unquoted attribute value must be a string or a mustache, preceded by whitespace or a '=' character, and followed by whitespace, a '>' character, or '/>'",s)}}return Kt(t)?t[0]:d.text({chars:"",loc:s})}constructor(...t){super(...t),this.tagOpenLine=0,this.tagOpenColumn=0}},ui={},mr=class extends Xe{constructor(){super({})}parse(){}};function Ps(e,t={}){let r,n,s,i=t.mode||"precompile";typeof e=="string"?(r=new ft(e,t.meta?.moduleName),n=i==="codemod"?de(e,t.parseOptions):$e(e,t.parseOptions)):e instanceof ft?(r=e,n=i==="codemod"?de(e.source,t.parseOptions):$e(e.source,t.parseOptions)):(r=new ft("",t.meta?.moduleName),n=e),i==="codemod"&&(s=new mr);let a=A.forCharPositions(r,0,r.source.length);n.loc={source:"(program)",start:a.startPosition,end:a.endPosition};let o=new fr(r,s,i).parse(n,t.locals??[]);if(t.plugins?.ast)for(let c of t.plugins.ast)li(o,c(Ye({},t,{syntax:ui},{plugins:void 0})).visitor);return o}var hi={resolution:()=>ge.GetStrictKeyword,serialize:()=>"Strict",isAngleBracket:!1},Uo={...hi,isAngleBracket:!0};function pi(e,t){let r=new SyntaxError(e+" ("+t.loc.start.line+":"+t.loc.start.column+")");return Object.assign(r,t)}var Cs=pi;var Ls=Symbol.for("PRETTIER_IS_FRONT_MATTER");var Wt=3;function fi(e){let t=e.slice(0,Wt);if(t!=="---"&&t!=="+++")return;let r=e.indexOf(`
`,Wt);if(r===-1)return;let n=e.slice(Wt,r).trim(),s=e.indexOf(`
${t}`,r),i=n;if(i||(i=t==="+++"?"toml":"yaml"),s===-1&&t==="---"&&i==="yaml"&&(s=e.indexOf(`
...`,r)),s===-1)return;let a=s+1+Wt,o=e.charAt(a+1);if(!/\s?/u.test(o))return;let c=e.slice(0,a),h;return{language:i,explicitLanguage:n||null,value:e.slice(r+1,s),startDelimiter:t,endDelimiter:c.slice(-Wt),raw:c,start:{line:1,column:0,index:0},end:{index:c.length,get line(){return h??(h=c.split(`
`)),h.length},get column(){return h??(h=c.split(`
`)),V(0,h,-1).length}},[Ls]:!0}}function mi(e){let t=fi(e);return t?{frontMatter:t,get content(){let{raw:r}=t;return St(0,r,/[^\n]/gu," ")+e.slice(r.length)}}:{content:e}}var _s=mi;function di(e){let t=e.children??e.body;if(t)for(let r=0;r<t.length-1;r++)t[r].type==="TextNode"&&t[r+1].type==="MustacheStatement"&&(t[r].chars=t[r].chars.replace(/\\$/u,"\\\\"))}var gi=e=>{let{start:t,end:r}=e.loc;t.offset=e.loc.getStart().offset,r.offset=e.loc.getEnd().offset},bi=()=>({name:"glimmerPrettierParsePlugin",visitor:{All(e){gi(e),di(e)}}}),yi={mode:"codemod",plugins:{ast:[bi]}};function Si(e){let{frontMatter:t,content:r}=_s(e),n;try{n=Ps(r,yi)}catch(s){let i=Ei(s);if(i){let a=ki(s);throw Cs(a,{loc:i,cause:s})}throw s}if(t){let s={...t,type:"FrontMatter",loc:{start:{...t.start,offset:t.start.index},end:{...t.end,offset:t.end.index}}};n.body.unshift(s)}return n}function ki(e){let{message:t}=e,r=t.split(`
`);return r.length>=4&&/^Parse error on line \d+:$/u.test(r[0])&&/^-*\^$/u.test(V(0,r,-2))?V(0,r,-1):r.length>=4&&/:\s?$/u.test(r[0])&&/^\(error occurred in '.*?' @ line \d+ : column \d+\)$/u.test(V(0,r,-1))&&r[1]===""&&V(0,r,-2)===""&&r.slice(2,-2).every(n=>n.startsWith("|"))?r[0].trim().slice(0,-1):t}function Ei(e){let{location:t,hash:r}=e;if(t){let{start:n,end:s}=t;return typeof s.line!="number"?{start:n}:t}if(r){let{loc:{last_line:n,last_column:s}}=r;return{start:{line:n,column:s+1}}}}var vi={parse:Si,astFormat:"glimmer",locStart:ht,locEnd:Vt};var wi={glimmer:rs};export{Ds as default,ss as languages,br as parsers,wi as printers};
