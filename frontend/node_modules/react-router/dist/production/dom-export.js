...
function HydratedRouter(props) {
  ...
  React2.useEffect(() => {
    if (process.env.NODE_ENV === "development" && criticalCss === void 0) {
      document.querySelectorAll(`[${_chunkEAIF67OWjs.CRITICAL_CSS_DATA_ATTRIBUTE}]`).forEach((element) => element.remove());
    }
  }, [criticalCss]);
...
function createRouterFromPayload({
  ...
  _chunkG5A35OQUjs.populateRSCRouteModules.call(void 0, globalVar.__reactRouterRouteModules, payload.matches);
  let patches = /* @__PURE__ */ new Map();
  _optionalChain([payload, 'access', _22 => _22.patches, 'optionalAccess', _23 => _23.forEach, 'call', _24 => _24((patch) => {
    _chunkEAIF67OWjs.invariant.call(void 0, patch.parentId, "Invalid patch parentId");
  ...
  globalVar.__reactRouterDataRouter = _chunkEAIF67OWjs.createRouter.call(void 0, {
    routes,
    getContext,
    basename: payload.basename,
    history: _chunkEAIF67OWjs.createBrowserHistory.call(void 0, ),
    hydrationData: _chunkG5A35OQUjs.getHydrationData.call(void 0, {
      state: {
      ...
      getRouteInfo: (routeId) => {
        ...
        _chunkEAIF67OWjs.invariant.call(void 0, match, "Route not found in payload");
        return {
...
var renderedRoutesContext = _chunkEAIF67OWjs.createContext.call(void 0, );
function getRSCSingleFetchDataStrategy(getRouter, ssr, basename, createFromReadableStream, fetchImplementation) {
  let dataStrategy = _chunkEAIF67OWjs.getSingleFetchDataStrategyImpl.call(void 0, 
    getRouter,
    (match) => {
      let M = match;
      return {
...
function getFetchAndDecodeViaRSC(createFromReadableStream, fetchImplementation) {
  return async (args, basename, targetRoutes) => {
    ...
    let url = _chunkEAIF67OWjs.singleFetchUrl.call(void 0, request.url, basename, "rsc");
    if (request.method === "GET") {
      url = _chunkEAIF67OWjs.stripIndexParam.call(void 0, url);
      if (targetRoutes) {
        url.searchParams.set("_routes", targetRoutes.join(","));
      }
    }
    let res = await fetchImplementation(
      new Request(url, await _chunkEAIF67OWjs.createRequestInit.call(void 0, request))
    );
    if (res.status >= 400 && !res.headers.has("X-Remix-Response")) {
      throw new (0, _chunkEAIF67OWjs.ErrorResponseImpl)(res.status, res.statusText, await res.text());
    }
    _chunkEAIF67OWjs.invariant.call(void 0, res.body, "No response body to decode");
    try {
      ...
      let results = { routes: {} };
      const dataKey = _chunkEAIF67OWjs.isMutationMethod.call(void 0, request.method) ? "actionData" : "loaderData";
...
function RSCHydratedRouter({
  ...
  React3.useEffect(() => {
    _chunkEAIF67OWjs.setIsHydrated.call(void 0, );
  }, []);
  ...
  return /* @__PURE__ */ React3.createElement(_chunkEAIF67OWjs.RSCRouterContext.Provider, { value: true }, /* @__PURE__ */ React3.createElement(_chunkG5A35OQUjs.RSCRouterGlobalErrorBoundary, { location: location2 }, /* @__PURE__ */ React3.createElement(_chunkEAIF67OWjs.FrameworkContext.Provider, { value: frameworkContext }, /* @__PURE__ */ React3.createElement(_chunkEAIF67OWjs.UNSTABLE_TransitionEnabledRouterProvider, { router: router2, flushSync: ReactDOM2.flushSync }))));
}
function createRouteFromServerManifest(match, payload) {
  ...
  _chunkEAIF67OWjs.invariant.call(void 0, window.__reactRouterRouteModules);
  _chunkG5A35OQUjs.populateRSCRouteModules.call(void 0, window.__reactRouterRouteModules, match);
  let dataRoute = {
    id: match.id,
    ...
    action: match.clientAction ? (args, singleFetch) => match.clientAction({
      ...
      throw _chunkEAIF67OWjs.noActionDefinedError.call(void 0, "action", match.id);
    },
    path: match.path,
  ...
  if (typeof dataRoute.loader === "function") {
    dataRoute.loader.hydrate = _chunkEAIF67OWjs.shouldHydrateRouteLoader.call(void 0, 
      match.id,
      match.clientLoader,
      match.hasLoader,
      false
...
function callSingleFetch(singleFetch) {
  _chunkEAIF67OWjs.invariant.call(void 0, typeof singleFetch === "function", "Invalid singleFetch parameter");
  return singleFetch();
}
function preventInvalidServerHandlerCall(type, routeId, hasHandler) {
  if (!hasHandler) {
    ...
    console.error(msg);
    throw new (0, _chunkEAIF67OWjs.ErrorResponseImpl)(400, "Bad Request", new Error(msg), true);
  }
}
